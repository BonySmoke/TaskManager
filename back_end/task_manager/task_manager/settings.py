...
SITE_ID = 1 #django_authentication

#django-allauth settings

ACCOUNT_AUTHENTICATION_METHOD = 'username' #user is authenticated by 'username'

ACCOUNT_EMAIL_VERIFICATION = 'none' #the email won't be verified after signing up
